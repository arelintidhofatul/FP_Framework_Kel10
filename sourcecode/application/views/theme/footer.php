<footer class="footer">
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <img width="150" src="<?php echo base_url('');?>style/img/sma-angkasa-logo.png" class="rounded" alt="Muris Studio">
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
  ...
  Copyright 2021 @ SMA Terpadu Angkasa Surabaya</a> </p>
                        </p>
                    </div>
                </div>
            </div>
